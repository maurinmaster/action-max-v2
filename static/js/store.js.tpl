...
DOMContentLoaded.addEventOrExecute(() => {
    ...
    jQueryNuvem(".js-calculate-shipping").on("click", function (e) {
        ...
        let shippingForm = jQueryNuvem(e.currentTarget).closest(".js-shipping-calculator-form");
        let shipping_input_val = shippingForm.find(".js-shipping-input").val();

        jQueryNuvem(".js-shipping-input").val(shipping_input_val);

        {# Only recalculate the cart widget when the click actually came from it #}

        if (shippingForm.closest("#cart-shipping-container").length) {
