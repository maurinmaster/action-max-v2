...
{% if show_cart_fulfillment %}
  <div class="js-fulfillment-info js-allows-non-shippable cart-fulfillment-info {% if cart_page %}mb-4{% else %}mt-4{% endif %}" {% if not cart.has_shippable_products %}style="display: none"{% endif %}>
